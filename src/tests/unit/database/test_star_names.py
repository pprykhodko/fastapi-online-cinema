...
@pytest.mark.parametrize("factory", [StarModel, StarCreateRequestSchema, StarUpdateRequestSchema])
@pytest.mark.parametrize("name", [
    "Tom Hanks", "Jean-Claude Van Damme", " Mary Smith-Jones ", "Keanu",
])
...
@pytest.mark.parametrize("factory", [StarModel, StarCreateRequestSchema, StarUpdateRequestSchema])
@pytest.mark.parametrize("name", [
    "123", "Tom2", "Том", "Penélope Cruz", "Tom!", "Tom?", "O'Connor",
    "—-", "---", " - - ", "", "   ", "Tom\tHanks", "Tom\nHanks",
    "Tom—Hanks", "-Tom", "Tom-", "Tom--Hanks", "Tom - Hanks",
])
