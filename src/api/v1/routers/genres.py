...
@router.get(
    ...
    summary="Get a genre",
    description="Public lookup by genre ID.",
    responses=not_found
)
async def get_genre(
...
@router.post(
    ...
    description=(
            "MODERATOR or ADMIN only. Supply name (1–100 English letters and spaces). "
...
@router.patch(
    ...
    description=(
            ...
            "(1–100 English letters and spaces). Movie associations are preserved."
    )
)
