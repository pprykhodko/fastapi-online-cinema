...
write_responses: dict[int | str, dict[str, Any]] = {
    ...
    409: {
        "model": ErrorResponseSchema, "description": "Duplicate director name",
    }
}
not_found: dict[int | str, dict[str, Any]] = {
    404: {"model": ErrorResponseSchema, "description": "Director not found."}
}
...
@router.get(
    ...
    description=(
        "Public list of directors ordered by ID. Returns an empty list "
        "when no directors exist."
    ),
)
...
@router.post(
    "/", response_model=DirectorResponseSchema, status_code=201,
...
@router.patch(
    "/{director_id}/", response_model=DirectorResponseSchema,
