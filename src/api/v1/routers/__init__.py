...
from src.api.v1.routers.cart import router as cart_router
...
from src.api.v1.routers.comments import router as comments_router
...
__all__ = [
    ...
    "comments_router", "cart_router", "orders_router", "payments_router",
]
